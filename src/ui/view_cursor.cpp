...
namespace ui {
    ...
    std::unique_ptr<ViewCursor> ViewCursor::create_from(View &owning_view) {
        ...
        vc->view = &owning_view;
        vc->shader = shader;
        vc->setup_dimensions(5, font->max_glyph_height + 4);
        return vc;
    }
    ...
    void ViewCursor::set_projection(glm::mat4 orthoProjection) { projection = orthoProjection; }
    ...
    void ViewCursor::update_cursor_data_end(GLfloat i, GLfloat i1) {
